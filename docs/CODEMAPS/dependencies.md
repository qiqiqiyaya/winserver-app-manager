<!-- Generated: 2026-07-11 | Files scanned: 139 | Token estimate: ~600 -->
...
| Microsoft.Web.Administration | IIS site/pool management | Domain |
| System.ServiceProcess.ServiceController | Windows service management | Domain |
...
|---|---|---|
| IIS Manager | `IIisManager` | Microsoft.Web.Administration.ServerManager |
| Windows Service Control | `IWindowsServiceManager` | ServiceController + sc.exe process |
...
|---|---|
| .NET 8 SDK | Build & run |
| ABP CLI | Project scaffolding, migration tooling |
