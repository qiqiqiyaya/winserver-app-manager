    ...
    public virtual async Task SeedAsync(DataSeedContext context)
    {
        await _permissionDataSeeder.SeedAsync(
            ...
            new[]
            {
                ...
                AppManagerPermissions.IisInstances.Default,
                AppManagerPermissions.IisInstances.Create,
                AppManagerPermissions.IisInstances.Edit,
                AppManagerPermissions.IisInstances.Delete,
