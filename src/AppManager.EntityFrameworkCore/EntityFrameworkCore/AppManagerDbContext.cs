...
using AppManager.EntityFrameworkCore.Configurations;
...
public class AppManagerDbContext :
    AbpDbContext<AppManagerDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    /* Add DbSet properties for your Aggregate Roots / Entities here. */

    public DbSet<IisSiteEntity> IisSites { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new IisSiteConfiguration());
