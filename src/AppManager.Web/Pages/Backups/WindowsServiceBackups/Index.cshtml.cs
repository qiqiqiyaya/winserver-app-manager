...
namespace AppManager.Web.Pages.Backups.WindowsServiceBackups;

public class IndexModel : AppManagerPageModel
{
    private readonly IWindowsServiceBackupAppService _backupAppService;

    [BindProperty(SupportsGet = true)]
    public GetBackupListDto Input { get; set; } = new();

    public IndexModel(IWindowsServiceBackupAppService backupAppService) { _backupAppService = backupAppService; }
